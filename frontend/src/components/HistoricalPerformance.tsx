    ...
    <div className="rounded-lg border border-white/10 bg-slate-800/40 p-4 backdrop-blur-sm">
      ...
      <div className="h-48">
        <ResponsiveContainer width="100%" height="100%">
          {/* No negative left margin. It was there to reclaim whitespace, but a
              negative margin shifts the Y axis off the canvas rather than
              shrinking it, so every tick lost 12px from its left edge — enough
              to cut the leading digit off "100%" on the percentage charts. The
              axis widths below already reserve only what the labels need. */}
